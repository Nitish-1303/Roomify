...
const InfoButton = React.forwardRef(({ className, children, ...props }, ref) => (
  <Button
    ref={ref}
    variant="outline"
    className={cn(
...
export const BookingForm = React.forwardRef(
  (
    {
      className,
      destination,
      ...
      >
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            <h3 className="font-medium text-card-foreground">Room</h3>
