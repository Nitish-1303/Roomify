        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mt-6 p-4 bg-muted/50 rounded-lg text-sm">
            ...
            <div className="space-y-1 text-muted-foreground">
              <p>👤 <span className="font-medium">User:</span> user@roomify.com / user123</p>
              <p>👑 <span className="font-medium">Admin:</span> admin@roomify.com / admin123</p>
            </div>
          </div>
